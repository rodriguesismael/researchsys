...
--
-- Host: localhost
-- Tempo de geração: 19/10/2018 às 23:09
...
INSERT INTO `alternativas` (`id`, `alternativa`, `questionarios_id`, `ordem`) VALUES
(1, 'Concordo Plenamente', 4, 1),
(2, 'Concordo', 4, 2),
(3, 'Concordo na maior parte das vezes', 4, 3),
(4, 'Discordo na maior parte das vezes', 4, 4),
(5, 'Discordo', 4, 5),
(6, 'Discordo Plenamente', 4, 6),
(7, 'Com certeza escolheria A.', 5, 1),
(8, 'Provavelmente escolheria A.', 5, 2),
(9, 'Provavelmente escolheria B.', 5, 3),
(10, 'Com certeza escolheria B.', 5, 4),
(11, 'Discordo fortemente.', 6, 1),
(12, 'Discordo.', 6, 2),
(13, 'Sou neutro.', 6, 3),
(14, 'Concordo.', 6, 4),
(15, 'Concordo fortemente', 6, 5),
...
INSERT INTO `cidades` (`id`, `nome`, `estado_uf`) VALUES
...
INSERT INTO `convidados` (`id`, `randomid`, `email`, `idlista`) VALUES
(1, '1190303545baebe3e773fc', 'isrodrigues5@gmail.com', 21);
...
(2, 'Bacharelado em Administração Pública'),
(3, 'Bacharelado em Arquitetura e Urbanismo'),
(4, 'Bacharelado em Artes Cênicas'),
(5, 'Licenciatura em Artes Visuais'),
(6, 'Bacharelado em Artes Visuais'),
(7, 'Licenciatura e bacharelado em Artes Visuais '),
(8, 'Bacharelado em Ciências da Computação'),
(9, 'Bacharelado em Ciências Biológicas'),
(10, 'Licenciatura em Ciências Biológicas'),
(11, 'Bacharelado e licenciatura em Ciências biológicas'),
(12, 'Bacharelado em Ciências do Esporte'),
(13, 'Bacharelado em Ciências Econômicas'),
(14, 'Bacharelado em Ciências Sociais'),
(15, 'Licenciatura em Ciências Sociais'),
(16, 'Bacharelado e licenciatura em Ciências Sociais'),
(17, 'Bacharelado em Comunicação Social –Midialogia'),
(18, 'Bacharelado em Construção de Edifícios'),
(19, 'Curso 51-Engenharia Física'),
(20, 'Curso 51-Física'),
(21, 'Curso 51- Física Médica e Biomédica'),
(22, 'Curso 51-Matemática'),
(23, 'Curso 51 - Matemática Aplicada e Computacional'),
(24, 'Licenciatura em Dança'),
(25, 'Bacharelado em Dança'),
(26, 'Bacharelado e licenciatura em dança'),
(27, 'Bacharelado em Educação Física'),
(28, 'Licenciatura em Educação Física'),
(29, 'Bacharelado e licenciatura em Educação física'),
(30, 'Licenciatura em Enfermagem'),
(31, 'Bacharelado em Enfermagem'),
(32, 'Bacharelado e Licencitura em Enfermagem'),
(33, 'Bacharelado em Engenharia Agrícola'),
(34, 'Bacharelado em Engenharia Ambiental'),
(35, 'Bacharelado em Engenharia Civil'),
(36, 'Bacharelado em Engenharia de Alimentos'),
(37, 'Bacharelado em Engenharia da Computação'),
(38, 'Bacharelado em Engenharia de Controle e Automação'),
(39, 'Bacharelado em Engenharia de Manufatura'),
(40, 'Bacharelado em Engenharia de Produção'),
(41, 'Bacharelado em Engenharia de Telecomunicações'),
(42, 'Bacharelado em Engenharia de Transportes'),
(43, 'Bacharelado em Engenharia Elétrica'),
(44, 'Bacharelado em Engenharia Mecânica (Bacharelado)'),
(45, 'Bacharelado em Engenharia Química'),
(46, 'Bacharelado em Estatística'),
(47, 'Bacharelado em Estudos Literários'),
(48, 'Bacharelado em Farmácia'),
(49, 'Bacharelado em Filosofia'),
(50, 'Licenciatura em Filosofia'),
(51, 'Bacharelado e Licenciatura em Filosofia'),
(52, 'Bacharelado e licenciatura em Física'),
(53, 'Bacharelado em Física'),
(54, 'Licenciatura em Física'),
(55, 'Bacharelado em Fonoaudiologia'),
(56, 'Bacharelado em Geografia'),
(57, 'Licenciatura em Geografia'),
(58, 'Bacharelado e licenciatura em Geografia'),
(59, 'Bacharelado em Geologia'),
(60, 'Bacharelado em História'),
(61, 'Licenciatura em História'),
(62, 'Bacharelado e licenciatura em História'),
(63, 'Licenciatura em Letras'),
(64, 'Licenciatura Integrada – Química e Física'),
(65, 'Bacharelado em Linguística'),
(66, 'Bacharelado em Matemática'),
(67, 'Bacharelado e licenciatura em Matemática'),
(68, 'Licenciatura em Matemática'),
(69, 'Bacharelado em Medicina'),
(70, 'Bacharelado em Música: Composição '),
(71, 'Licenciatura em Música Composição'),
(72, 'Bacharelado e Licenciatura em Música: composição'),
(73, 'Bacharelado em Música Erudita: Instrumentos'),
(74, 'Licenciatura em Música Erudita: Instrumentos'),
(75, 'Bacharelado e Licenciatura em Música Erudita: Instrumentos'),
(76, 'Bacharelado em Música'),
(77, 'Licenciatura em Música'),
(78, 'Bacharelado e Licenciatura em Música'),
(79, 'Bacharelado em Música Popular: Instrumentos'),
(80, 'Licenciatura em Música Popular: Instrumentos'),
(81, 'Bacharelado e Licenciatura em Música Popular: Instrumentos'),
(82, 'Bacharelado em Música: Regência'),
(83, 'Licenciatura em Música: Regência'),
(84, 'Bacharelado e Licenciatura em Música: Regência'),
(85, 'Bacharelado em Nutrição'),
(86, 'Bacharelado em Odontologia'),
(87, 'Licenciatura em Pedagogia'),
(88, 'Bacharelado em Química'),
(89, 'Licenciatura em Química'),
(90, 'Bacharelado e licenciatura em Química'),
(91, 'Bacharelado e tecnológico em Química'),
(92, 'Bacharelado, licenciatura e tecnológico em Química'),
(93, 'Bacharelado em Química Tecnológica'),
(94, 'Bacharelado em  Sistema de Informação'),
(95, 'Bacharelado em Tecnologia em Análise e Desenvolvimento de Sistemas'),
(96, 'Bacharelado em Tecnologia em Saneamento Básico'),
(97, 'Bacharelado em Agronomia'),
(98, 'Bacharelado em Arquivologia'),
(99, 'Bacharelado em Biblioteconomia'),
(100, 'Bacharelado em Biomedicina'),
(101, 'Bacharelado em Ciências Contábeis'),
(102, 'Bacharelado em Design de Moda'),
(103, 'Bacharelado em Design Gráfico'),
(104, 'Bacharelado em Direito'),
(105, 'Bacharelado em Fisioterapia'),
(106, 'Bacharelado em Jornalismo'),
(107, 'Bacharelado em Medicina Veterinária'),
(108, 'Bacharelado em Relações Públicas'),
(109, 'Bacharelado em Odontologia'),
(110, 'Bacharelado em Psicologia'),
(111, 'Bacharelado em Secretariado Executivo'),
(112, 'Bacharelado em Serviço Social'),
(113, 'Bacharelado em Zootecnia'),
(114, 'Bacharelado em Agroecologia'),
(115, 'Bacharelado em Biotecnologia'),
(116, 'Bacharelado em Bibioteconomia e Ciências da Informação'),
(117, 'Licenciatura em Educação Especial'),
(118, 'Licenciatura em Educação Musical'),
(119, 'Bacharelado em Engenharia Agronômica'),
(120, 'Bacharelado em Engenharia de Materiais'),
(121, 'Bacharelado em Engenharia Física'),
(122, 'Bacharelado em Engenharia Florestal'),
(123, 'Bacharelado em Gerontologia'),
(124, 'Bacharelado em Gestão e Análise Ambiental'),
(125, 'Bacharelado em Imagem e Som'),
(126, 'Bacharelado em Tecnologia em Produção Sucroalcooleira'),
(127, 'Bacharelado em Terapia Educacional'),
(128, 'Bacharelado em Tradução e Interpretação em Língua Brasileira de Sinais'),
(129, 'Bacharelado em Antropologia'),
(130, 'Bacharelado em Cinema de Animação'),
(131, 'Bacharelado em Cinema e Audiovisual'),
(132, 'Bacharelado em Conservação e restauração de bens culturais móveis'),
(133, 'Bacharelado em Design Digital'),
(134, 'Bacharelado em Engenharia Ambiental e Sanitária'),
(135, 'Bacharelado em Engenharia de Petróleo'),
(136, 'Bacharelado em Engenharia Geológica'),
(137, 'Bacharelado em Engenharia Hídrica'),
(138, 'Bacharelado em Engenharia Industrial Madeireira'),
(139, 'Bacharelado em Gestão Ambiental'),
(140, 'Bacharelado em Meteorologia'),
(141, 'Bacharelado em Museologia'),
(142, 'Bacharelado em Música-Canto'),
(143, 'Bacharelado em Música – Ciências Musicais'),
(144, 'Bacharelado em  Música – Composição'),
(145, 'Bacharelado em Música – Flauta Transversal'),
(146, 'Bacharelado em Música – Música Popular'),
(147, 'Bacharelado em Música – Piano'),
(148, 'Bacharelado em Música – Violino'),
(149, 'Bacharelado em Música – Violão'),
(150, 'Bacharelado em Nutrição'),
(151, 'Bacharelado em Química de Alimentos'),
(152, 'Bacharelado em  Química Forense'),
(153, 'Bacharelado em Química Industrial'),
(154, 'Bacharelado em Relações Internacionais'),
(155, 'Licenciatura em Teatro'),
(156, 'Tecnológico em Alimentos'),
(157, 'Tecnológico em Gastronomia'),
(158, 'Tecnológico em Geoprocessamento'),
(159, 'Tecnológico em Gestão Pública'),
(160, 'Tecnológico em Processos Gerenciais'),
(161, 'Tecnológico em Transporte Terrestre'),
(162, 'Bacharelado em Artes Visuais – Escultura'),
(163, 'Bacharelado em Astronomia'),
(164, 'Bacharelado em Letras'),
(165, 'Bacharelado em Biblioteconomia e Gestão de Unid Informação'),
(166, 'Bacharelado em Ciências Atuariais / Estatística (Básico)'),
(167, 'Bacharelado em Ciências Biológicas (Básico)'),
(168, 'Bacharelado em Ciências Biológicas - Modalidade Médica'),
(169, 'Bacharelado em Ciências Biológicas: Biofísica'),
(170, 'Bacharelado em Ciências Biológicas: Biotecnologia'),
(171, 'Bacharelado em Ciências Biológicas: Microbiol e Imunologia'),
(172, 'Bacharelado em Ciências Matemáticas e da Terra'),
(173, 'Bacharelado em Composição de Interior'),
(174, 'Bacharelado em Composição Paisagística'),
(175, 'Bacharelado em Comunicação Social (Básico)'),
(176, 'Bacharelado em Comunicação Visual Design'),
(177, 'Bacharelado em Conservação e Restauração'),
(178, 'Bacharelado em Defesa e Gestão Estratégica Internacional'),
(179, 'Bacharelado em Desenho Industrial'),
(180, 'Bacharelado em Enfermagem e Obstetrícia'),
(181, 'Bacharelado em Engenharia (Básico)'),
(182, 'Bacharelado em Engenharia (Ciclo Básico)'),
(183, 'Bacharelado em Engenharia (Núcleo Comum)'),
(184, 'Bacharelado em Engenharia de Computação e Informação'),
(185, 'Bacharelado em Escola de Química (Ciclo Básico)'),
(186, 'Bacharelado em Escultura'),
(187, 'Bacharelado em Farmácia - Farmacêutico'),
(188, 'Bacharelado em Filosofia (Básico)'),
(189, 'Bacharelado em Física Médica'),
(190, 'Bacharelado em Gastronomia'),
(191, 'Bacharelado em Gestão Pública Desenv Econômico e Social'),
(192, 'Bacharelado em Gravura'),
(193, 'Bacharelado em História da Arte'),
(194, 'Bacharelado em Letras – Libras'),
(195, 'Licenciatura em Ed Artística'),
(196, 'Licenciatura em Música'),
(197, 'Bacharelado em Matemática Aplicada'),
(198, 'Bacharelado em Meteorologia'),
(199, 'Bacharelado em Nanotecnologia'),
(200, 'Bacharelado em Pedagogia (Básico)'),
(201, 'Bacharelado em Pintura'),
(202, 'Bacharelado em Saúde Coletiva'),
(203, 'Bacharelado em Serviço Social'),
(204, 'Bacharelado em Teoria da Dança'),
(205, 'Bacharelado em Terapia Ocupacional');
...
INSERT INTO `participantes` (`uid`, `ra`, `nome`, `email`, `genero`, `etnia`, `nascimento`, `semestre`, `tipo_ensino`, `periodo_curso`, `intencao_academica`, `minhas_notas`, `estadoAcesso`, `universidades_id`, `curso_id`, `cidade`, `estado`) VALUES
('00eao4d', 10721, 'Michelle York', 'Aenean.massa@volutpat.co.uk', 1, 4, '1990-07-10', 1, 2, 1, 5, 5, NULL, 14, 24, NULL, NULL),
('01owx2f', 20944, 'Ciara Heath', 'sed@lobortisaugue.co.uk', 1, 6, '1995-03-08', 10, 3, 1, 3, 3, NULL, 16, 17, NULL, NULL),
('02pra0t', 88409, 'Buckminster Santana', 'lacconsectetuer@quispedePraesent.edu', 2, 6, '1982-05-26', 10, 1, 4, 7, 1, NULL, 15, 4, NULL, NULL),
('03siw5k', 35660, 'Amy Conrad', 'convallis@antedictum.com', 1, 6, '1980-07-01', 10, 1, 3, 2, 6, NULL, 15, 2, NULL, NULL),
('03veh9u', 4303, 'Karyn Durham', 'porttitor.vulputate@primisin.org', 2, 1, '1980-12-15', 4, 1, 4, 2, 6, NULL, 14, 10, NULL, NULL),
('07gru7q', 59732, 'Chava Sharp', 'meeuismod@diameudolor.edu', 1, 6, '1990-09-11', 1, 1, 1, 7, 2, NULL, 15, 15, NULL, NULL),
('07nba9z', 79270, 'William Shields', 'lorem@augueeutempor.edu', 1, 1, '1970-07-25', 8, 1, 1, 5, 1, NULL, 14, 13, NULL, NULL),
('09ltd1g', 75836, 'Georgia Flowers', 'Integer@Phasellusinfelis.com', 1, 4, '1978-03-26', 8, 1, 2, 4, 1, NULL, 15, 5, NULL, NULL),
('11vnz1q', 90068, 'Megan Snyder', 'blandit.mattis.Cras@elitEtiam.edu', 2, 2, '1980-08-30', 1, 1, 3, 2, 5, NULL, 14, 1, NULL, NULL),
('12jkf0m', 85456, 'Megan Leon', 'a.purus.Duis@convallisantelectus.com', 2, 2, '1996-11-11', 4, 3, 1, 5, 1, NULL, 16, 13, NULL, NULL),
('13gyc7d', 31994, 'Joy Espinoza', 'bibendum.fermentum@Donecest.org', 2, 1, '1995-11-10', 9, 2, 4, 1, 3, NULL, 15, 12, NULL, NULL),
('13rkl6z', 2855, 'Clark Huffman', 'vestibulum.nec@Donecelumlorem.edu', 2, 5, '1995-02-07', 7, 2, 2, 6, 2, NULL, 14, 11, NULL, NULL),
('15eqg0s', 46691, 'Rhiannon Cline', 'cursus@pedeultricesa.com', 1, 5, '1991-05-05', 10, 1, 4, 2, 3, NULL, 14, 1, NULL, NULL),
('15puk4i', 96071, 'Norman Levy', 'lacinia.mattis.Integer@Praesent.net', 1, 2, '1992-09-07', 9, 2, 0, 5, 2, NULL, 15, 2, NULL, NULL),
('16ufn5h', 99279, 'Owen Whitney', 'vulputate@neque.ca', 2, 3, '1997-06-09', 8, 2, 3, 7, 4, NULL, 16, 17, NULL, NULL),
('20rpo5u', 35462, 'Chastity Haynes', 'turpis@metusInnec.com', 1, 1, '1990-04-26', 5, 1, 1, 7, 5, NULL, 14, 19, NULL, NULL),
('23tzi5s', 15164, 'Reece Pratt', 'Curabitur.ut.odio@euodio.com', 2, 6, '1997-05-29', 6, 1, 2, 6, 4, NULL, 14, 4, NULL, NULL),
('23xmn1x', 13943, 'Reuben Carson', 'Donec@semegestasblandit.org', 1, 1, '1993-11-12', 2, 2, 4, 6, 2, NULL, 16, 12, NULL, NULL),
('23yuy5l', 24406, 'Timon Mckinney', 'vel@milaciniamattis.net', 1, 1, '1993-10-07', 1, 1, 4, 5, 6, NULL, 16, 2, NULL, NULL),
('24mrv9c', 63007, 'Xantha Combs', 'sem.Pellentesque.ut@commduntnibh.com', 3, 2, '1991-06-25', 8, 2, 4, 3, 2, NULL, 15, 14, NULL, NULL),
('25gqy7i', 80583, 'Samuel Acevedo', 'urna@viverra.edu', 2, 5, '1992-07-16', 6, 1, 4, 3, 4, NULL, 14, 17, NULL, NULL),
('26spk8p', 7058, 'Graiden Paul', 'adipiscing.fringilla@dapibusquam.edu', 1, 4, '2018-05-05', 2, 3, 1, 6, 2, NULL, 14, 4, NULL, NULL),
('27ojn8m', 58995, 'Gage Woodard', 'dolor@mienimcondimentum.edu', 2, 5, '1995-10-03', 6, 2, 3, 6, 4, NULL, 16, 18, NULL, NULL),
('28fcb7i', 46376, 'Yvette Gonzalez', 'in.faucibus@sitametmetus.co.uk', 2, 5, '1990-01-24', 7, 1, 2, 1, 4, NULL, 16, 3, NULL, NULL),
('28hlv4h', 48745, 'Carson Matthews', 'eu.uisque@arcuCurabiturut.co.uk', 1, 3, '1998-10-07', 10, 1, 1, 3, 5, NULL, 14, 17, NULL, NULL),
('30kah8n', 6996, 'Jeanette Simpson', 'ac@egestaslaciniaSed.net', 3, 2, '1994-11-13', 2, 3, 4, 3, 2, NULL, 16, 22, NULL, NULL),
('34gyd4d', 19122, 'Arsenio Crawford', 'non@lectusquis.edu', 3, 1, '1990-11-17', 5, 2, 2, 5, 2, NULL, 16, 7, NULL, NULL),
('35tom9b', 30995, 'Fletcher Donovan', 'rutrum.eu.ultrices@dolor.org', 3, 1, '1992-12-23', 7, 2, 3, 1, 1, NULL, 15, 11, NULL, NULL),
('36ada5d', 1085, 'Tanner Kaufman', 'nec.orci@Pellentebi.edu', 1, 1, '1980-03-23', 8, 1, 1, 1, 3, NULL, 14, 10, NULL, NULL),
('36dwc8w', 359, 'Willa Sawyer', 'pharetra.sed.hendrerit@arcu.edu', 1, 6, '1987-08-07', 3, 2, 4, 7, 4, NULL, 14, 1, NULL, NULL),
('36kth1p', 81928, 'Ebony Fields', 'nibh.lacinia@eu.org', 2, 1, '1984-11-14', 8, 2, 2, 4, 3, NULL, 16, 21, NULL, NULL),
('36qdw4r', 16645, 'Hilel Rojas', 'augue.id@magnis.ca', 3, 1, '1982-11-09', 1, 3, 2, 7, 5, NULL, 16, 10, NULL, NULL),
('37ppi7d', 47669, 'Joel Steele', 'Cras@lectusconvallis.edu', 1, 3, '1976-12-15', 5, 2, 3, 2, 6, NULL, 15, 22, NULL, NULL),
('38kij0q', 63967, 'Simone Perkins', 'turpis@adipiscing.edu', 1, 5, '1986-11-18', 6, 3, 1, 6, 2, NULL, 16, 11, NULL, NULL),
('39dwv8r', 68847, 'Levi Morrison', 'Donec@iaculislacus.ca', 1, 2, '1988-12-31', 9, 1, 3, 2, 4, NULL, 15, 24, NULL, NULL),
('39odh2z', 2503, 'Cameron Clemons', 'ligula@mollis.edu', 1, 1, '1988-03-07', 9, 3, 2, 4, 6, NULL, 15, 8, NULL, NULL),
('40oxg5y', 43513, 'Lionel Vinson', 'montes.nascetur@tincidevitae.net', 2, 2, '1989-03-24', 4, 3, 1, 5, 6, NULL, 14, 14, NULL, NULL),
('40tte6n', 53535, 'Maris Barker', 'imperdiet@sodales.ca', 1, 6, '1989-09-15', 2, 3, 1, 1, 1, NULL, 15, 11, NULL, NULL),
('40yeo3r', 41550, 'Dennis Witt', 'vitae@lobortisultrices.net', 2, 4, '1984-02-23', 2, 1, 1, 3, 4, NULL, 14, 2, NULL, NULL),
('41aeo4q', 90873, 'Pearl Simon', 'ut@auctorodioa.edu', 2, 3, '1979-04-06', 3, 3, 2, 3, 3, NULL, 14, 21, NULL, NULL),
('41gtm3b', 37690, 'Jasmine Mendez', 'amet@nibhvulputate.org', 1, 6, '1996-04-19', 7, 3, 1, 5, 6, NULL, 16, 12, NULL, NULL),
('41ror7h', 58098, 'Armando Weiss', 'lorem.Donec@posuerevulputatelacus.com', 2, 3, '1997-11-08', 3, 2, 1, 1, 1, NULL, 15, 1, NULL, NULL),
('42bks0j', 8470, 'Yolanda Norton', 'nisi.sem.semper@egestasnuncsed.net', 1, 2, '1990-03-31', 5, 1, 3, 3, 2, NULL, 15, 18, NULL, NULL),
('42crl3q', 39006, 'Kylie Morris', 'mi.Duis.risus@turpis.ca', 2, 1, '1990-07-23', 2, 1, 1, 6, 5, NULL, 14, 24, NULL, NULL),
('42ldr3z', 4693, 'Hannah Ochoa', 'erat.vitae@diamDuismi.edu', 2, 4, '1990-10-21', 4, 2, 2, 6, 3, NULL, 16, 16, NULL, NULL),
('42xev0c', 6690, 'Cecilia Graham', 'posuere.vulsadse@Aenegestas.net', 1, 5, '1983-01-17', 5, 3, 4, 5, 2, NULL, 15, 14, NULL, NULL),
('44tou0n', 56922, 'Brynne Tyson', 'ridiculus@mienim.co.uk', 1, 1, '1989-09-02', 5, 1, 4, 1, 1, NULL, 16, 7, NULL, NULL),
('45ghp3z', 31347, 'Quentin Burks', 'a.purus.Duis@leo.com', 2, 3, '1988-03-19', 4, 3, 2, 2, 5, NULL, 16, 23, NULL, NULL),
('45ooh7b', 73328, 'Dale Hart', 'erat@Aeneansedpede.co.uk', 2, 4, '1987-07-04', 8, 1, 1, 1, 3, NULL, 14, 15, NULL, NULL),
('46gsa4f', 58163, 'William Flowers', 'leo@at.net', 2, 1, '1990-01-11', 7, 2, 1, 2, 1, NULL, 14, 14, NULL, NULL),
('46hmo1t', 94481, 'Olympia Fisher', 'facilisis.eget@ac.com', 1, 1, '1987-09-02', 9, 1, 3, 2, 5, NULL, 14, 21, NULL, NULL),
('47ebp3u', 17566, 'Marsden Dodson', 'nunc.id.enim@lobortis.com', 2, 1, '1987-05-04', 5, 2, 1, 6, 6, NULL, 16, 6, NULL, NULL),
('50dfo5x', 427, 'Remedios Pena', 'felis.eget@consectetueripsum.com', 1, 1, '1989-09-09', 2, 1, 4, 7, 4, NULL, 15, 10, NULL, NULL),
('50jez1e', 34570, 'Hamilton Dennis', 'sagittis.augue.eu@loremut.org', 1, 6, '1987-12-27', 3, 1, 4, 5, 5, NULL, 14, 12, NULL, NULL),
('51tlw0s', 69597, 'Tad Benton', 'vitae.nibh@auctornunc.com', 2, 6, '1990-03-13', 1, 1, 3, 5, 2, NULL, 15, 1, NULL, NULL),
('53rqk5d', 91941, 'Callie England', 'Quisque@malesuada.net', 2, 3, '1988-12-16', 8, 1, 1, 5, 1, NULL, 16, 9, NULL, NULL),
('53vfz3o', 76425, 'Berk Witt', 'mollis.lectus.pede@fringillapurus.org', 2, 2, '1968-01-18', 7, 2, 2, 4, 6, NULL, 14, 7, NULL, NULL),
('55gkp7p', 70220, 'Hilel Marquez', 'justo.faucibus@sapien.edu', 2, 6, '1988-08-14', 1, 1, 3, 5, 1, NULL, 14, 11, NULL, NULL),
('55oev2c', 54155, 'Denton Gordon', 'tincidunt.nunc.ac@velitQuisque.edu', 1, 5, '1990-07-27', 7, 3, 2, 1, 3, NULL, 14, 12, NULL, NULL),
('55toh8n', 24865, 'Cameron Monroe', 'non.leo@malesuada.edu', 1, 1, '1990-02-08', 3, 1, 1, 1, 3, NULL, 16, 7, NULL, NULL),
('56ypu4c', 97439, 'Fallon Guthrie', 'Vestibulum@lobortisquispede.edu', 3, 5, '1984-05-29', 4, 3, 2, 1, 2, NULL, 16, 12, NULL, NULL),
('61lft0j', 79956, 'Grady Weber', 'magna@amet.org', 2, 1, '1985-10-06', 1, 3, 4, 5, 5, NULL, 16, 10, NULL, NULL),
('65omm3j', 10253, 'Adria Goff', 'Nunc.mauris@Donec.net', 1, 6, '1985-10-06', 8, 2, 3, 7, 6, NULL, 15, 24, NULL, NULL),
('65wkk2z', 65004, 'Colby Norris', 'sociis@ligula.net', 1, 4, '1989-06-16', 3, 2, 1, 4, 2, NULL, 16, 8, NULL, NULL),
('65wmc3e', 94937, 'Lewis Weiss', 'enim.mi.tempor@tortordictumeu.net', 1, 4, '1989-08-15', 3, 3, 1, 7, 1, NULL, 14, 10, NULL, NULL),
('67akz4f', 4255, 'Hillary Boyle', 'Donec.adipiscing@disparturient.edu', 1, 1, '1985-08-10', 5, 2, 2, 7, 4, NULL, 15, 18, NULL, NULL),
('67rlt8h', 5238, 'Zoe Wright', 'Sed.dictum@Nuncquis.com', 2, 2, '1992-03-25', 10, 2, 4, 7, 5, NULL, 15, 4, NULL, NULL),
('68mye9v', 92472, 'Dominique Holcomb', 'lectus.ante.dictum@maurissit.org', 2, 3, '1992-12-23', 1, 3, 2, 3, 2, NULL, 15, 5, NULL, NULL),
('69ftw7g', 65234, 'Lesley Mcdowell', 'orci.luctus@Aeneanegetmetus.ca', 1, 6, '1996-12-17', 5, 3, 2, 5, 3, NULL, 15, 8, NULL, NULL),
('69gsr0m', 69425, 'Malachi Mcclain', 'ac.turpis.egestas@a.org', 2, 1, '1999-09-28', 7, 3, 3, 5, 5, NULL, 14, 2, NULL, NULL),
('71feb6p', 59138, 'Glenna Jennings', 'aliquet.Phasellus@duiSuspendisse.co.uk', 2, 1, '1999-09-30', 1, 2, 3, 5, 2, NULL, 14, 3, NULL, NULL),
('71fli1i', 13168, 'Ebony Owen', 'at.lacus.Quisque@et.org', 2, 3, '1989-07-08', 6, 1, 4, 5, 6, NULL, 14, 13, NULL, NULL),
('71lei9z', 48899, 'Melinda Keller', 'consequat@Etiam.ca', 1, 5, '1987-02-19', 9, 2, 4, 1, 3, NULL, 15, 17, NULL, NULL),
('73hcg9q', 65425, 'Henry Bullock', 'ultricies.ornare@massaumaccumsan.edu', 2, 1, '1997-06-11', 9, 1, 1, 7, 5, NULL, 16, 8, NULL, NULL),
('76sjp0u', 48162, 'Nelle Faulkner', 'vehicula.aliquet.libero@acurnaUt.ca', 1, 4, '1997-11-10', 4, 1, 4, 2, 2, NULL, 16, 9, NULL, NULL),
('76zrr2m', 89053, 'Preston Carpenter', 'interdum@auctor.co.uk', 2, 5, '1998-06-04', 1, 3, 2, 7, 4, NULL, 15, 19, NULL, NULL),
('78igq5l', 19268, 'Savannah Adkins', 'ante.ipsum.primis@vel.net', 3, 1, '1996-10-19', 3, 1, 1, 6, 3, NULL, 15, 3, NULL, NULL),
('78mpd7i', 59260, 'Amir Joseph', 'nulla.Donec.non@neque.co.uk', 2, 5, '1994-08-20', 8, 2, 4, 5, 6, NULL, 15, 12, NULL, NULL),
('78uki0l', 20962, 'Kadeem Newman', 'sapien.molestie@arcuCurabitur.org', 2, 4, '1994-12-28', 4, 2, 2, 6, 5, NULL, 14, 13, NULL, NULL),
('80geq0e', 81684, 'Charissa Collins', 'luctus@orci.co.uk', 2, 5, '1996-12-11', 10, 2, 2, 6, 1, NULL, 16, 17, NULL, NULL),
('80syi2o', 15301, 'Bethany Reid', 'Integer.urna.Vivamus@Aliquarelibero.com', 1, 4, '1996-06-10', 1, 2, 4, 3, 1, NULL, 15, 5, NULL, NULL),
('81ihl9c', 42253, 'Mariam Brown', 'vitae.nibh.Donec@vulputatedui.edu', 1, 4, '1994-12-07', 4, 2, 4, 3, 5, NULL, 15, 18, NULL, NULL),
('81mtd8o', 48193, 'Yael French', 'ipsum.Donec.sollicitudin@enim.org', 2, 3, '1993-02-13', 6, 2, 3, 1, 1, NULL, 14, 16, NULL, NULL),
('84uwg8s', 22, 'Silas Olsen', 'suscipit.nonummy@vehicula.co.uk', 2, 2, '1999-03-07', 2, 2, 3, 1, 3, NULL, 16, 10, NULL, NULL),
('85boe4k', 11217, 'Troy Norris', 'nisi.nibh@massandisse.co.uk', 2, 6, '1989-01-26', 3, 1, 4, 1, 3, NULL, 14, 11, NULL, NULL),
('85iim1q', 18272, 'Rafael Thompson', 'massa.Mauris@eutellus.ca', 1, 6, '1988-06-15', 8, 3, 4, 1, 1, NULL, 16, 22, NULL, NULL),
('85tkz2o', 92653, 'Frances Head', 'Nunc.laoreet@felisegetvarius.com', 1, 2, '1988-08-29', 10, 3, 2, 1, 2, NULL, 16, 6, NULL, NULL),
('86ovs9t', 53953, 'Ryder Farrell', 'Nunc.laoreet@arcuSedeu.edu', 2, 1, '1995-07-26', 2, 3, 1, 6, 1, NULL, 15, 4, NULL, NULL),
('86qgy4q', 56621, 'Kimberley Page', 'nascetur@ametloremsemper.ca', 2, 2, '1996-05-29', 9, 2, 4, 6, 3, NULL, 15, 7, NULL, NULL),
('89lrb4n', 1063, 'Cecilia Lindsay', 'neque@malesuadafames.edu', 3, 6, '1994-11-30', 1, 2, 1, 7, 3, NULL, 16, 1, NULL, NULL),
('89oos2g', 20694, 'Tanek Gray', 'vitae.risus.Duis@metusfacilisis.ca', 2, 4, '1994-12-13', 9, 2, 2, 7, 3, NULL, 16, 19, NULL, NULL),
('90eah5q', 58851, 'Ila Mcconnell', 'eget.odio.Aliquam@ipsumDonec.org', 2, 4, '1980-07-26', 6, 1, 1, 2, 5, NULL, 16, 8, NULL, NULL),
('90oau0c', 55355, 'Callum Bentley', 'lacus@eu.com', 3, 3, '1980-07-12', 6, 3, 4, 3, 4, NULL, 15, 20, NULL, NULL),
('93nko6w', 88849, 'Stone Reed', 'ultrices.Vivamus.rhoncus@sapiencursus.ca', 2, 2, '1987-09-27', 5, 3, 4, 7, 2, NULL, 16, 9, NULL, NULL),
('93tjd5y', 59652, 'Samantha Bryant', 'lorem@eu.net', 2, 4, '1987-10-04', 3, 1, 3, 7, 1, NULL, 14, 24, NULL, NULL),
('94vty0j', 3560, 'Fleur Rowe', 'Duis.sit@molestie.co.uk', 2, 3, '1984-12-27', 4, 2, 1, 2, 1, NULL, 15, 13, NULL, NULL),
('96nje8y', 16901, 'Jada Mckenzie', 'posuere.vulputate@Aeneanegestas.net', 1, 6, '1985-03-22', 1, 3, 1, 7, 1, NULL, 14, 6, NULL, NULL),
('97tqj3g', 10202, 'Dorian Cote', 'ut@vestibulum.org', 0, 6, '1988-03-10', 9, 2, 2, 2, 6, NULL, 16, 14, NULL, NULL),
('98ygw1m', 68986, 'Gage Casey', 'cursus.vestibulum@eraperrutrum.com', 2, 3, '1999-06-09', 7, 1, 4, 5, 5, NULL, 16, 8, NULL, NULL),
('99bem8x', 64648, 'Aladdin Dorsey', 'vel@fermentum.net', 2, 4, '2000-09-21', 5, 2, 4, 1, 1, NULL, 14, 21, NULL, NULL),
('isrodrigues5$1190303545baebe3e773fc', 654321, 'Ismael Dev Teste', 'isrodrigues5@gmail.com', 2, 2, '1990-08-05', 3, 3, 3, 3, 3, 'a:5:{s:5:\"termo\";s:1:\"1\";s:9:\"PHPSESSID\";s:26:\"5k6u2o4lifi3gjfr7udrgjmqc5\";s:8:\"cadastro\";b:1;s:13:\"questionarios\";s:18:\"a:1:{i:0;s:1:\"8\";}\";s:12:\"demograficos\";s:266:\"https://ssl.collegelassi.com/portuguese/lassi.html?invnum=80010&ak=brazil&u=gyxc&p=wxk&requiredFirstName=Ismael&requiredLastName=Dev Teste&school=FURG-UniversidadeFederaldeRioGrande&idnum=isrodrigues5$1190303545baebe3e773fc&email=isrodrigues5@gmail.com&check_box=yes\";}', 25, 29, NULL, NULL);
...
(5, 'Você sempre pode mudar substancialmente o quão inteligente você é.', 4, 5),
(6, 'Você pode aprender coisas novas, mas não pode realmente mudar a sua inteligência.', 4, 6),
(7, 'Não importa quanto de inteligência você tem, você sempre pode modificá-la um pouco.', 4, 7),
(8, 'Você pode mudar consideravelmente o seu nível de inteligência.', 4, 8),
(9, '(A) Ir a um show favorito, a uma peça teatral ou a um evento esportivo e estudar menos para uma disciplina, mesmo que isso possa significar obter uma nota mais baixa em uma prova que você fará no dia seguinte, OU (B) Ficar em casa e estudar para aumentar suas chances de tirar uma nota mais alta.', 5, 1),
(10, '(A) Estudar um pouco todos os dias para uma prova de uma disciplina e passar menos tempo com os seus amigos, OU (B) Passar mais tempo com os seus amigos e “se matar de estudar” somente às vésperas da prova.', 5, 2),
(11, '(A) Faltar a várias aulas para aceitar um convite de uma viagem muito interessante, OU (B) Adiar a viagem até a disciplina terminar.', 5, 3),
(12, '(A) Ir a uma festa na véspera de uma prova e estudar somente se você tiver tempo, OU (B) Estudar primeiro e ir à festa somente se você tiver tempo.', 5, 4),
(13, '(A) Passar a maior parte do seu tempo estudando somente o conteúdo interessante de uma disciplina, mesmo que isso possa significar não se sair tão bem nela, OU (B) Estudar todo o conteúdo de uma disciplina para aumentar suas chances de se sair bem nela.', 5, 5),
(14, '(A) Matar a aula quando o dia está bonito e tentar conseguir as anotações com alguém depois, OU (B) Assistir à aula para ter certeza de que você não perderá nenhum conteúdo importante, mesmo que o dia esteja bonito lá fora.', 5, 6),
(15, '(A) Ficar na biblioteca para ter certeza de que você terminará uma tarefa de uma disciplina cujo prazo é no dia seguinte, OU (B) Ir mbora para se divertir com seus amigos e tentar terminar a tarefa mais tarde, quando chegar em casa à noite.', 5, 7),
(16, '(A) Estudar para uma disciplina em um lugar com muitos divertimentos ou distrações, OU (B) Estudar em um lugar onde há menos divertimentos ou distrações, para aumentar a probabilidade de você aprender o conteúdo.', 5, 8),
(17, '(A) Ir embora logo após a aula para fazer alguma coisa de que você goste, mesmo que isso, possivelmente, signifique não compreender um determinado conteúdo para uma prova, OU (B) Ficar depois da aula e pedir que seu professor esclareça algum conteúdo de prova que você não entendeu.', 5, 9),
(18, '(A) Escolher uma disciplina cujo(a) professor(a) seja “bonzinho/boazinha”, mesmo que ele/ela não faça um bom trabalho, ao cobrir o conteúdo programático, OU (B) Escolher uma disciplina cujo(a) o(a) professor(a) não seja tão “bonzinho/boazinha”, mas que faça um bom trabalho, ao cobrir o conteúdo programático.', 5, 10),
(19, 'Uso diferentes estratégias para me manter estudando, mesmo que eu não tenha vontade de estudar.', 6, 1),
(20, 'Se perco o interesse em uma tarefa, tenho maneiras de aumentar o meu esforço para realizá-la.', 6, 2),
(21, 'Se eu sinto vontade de parar de estudar, antes de realmente terminar, tenho estratégias para continuar estudando.', 6, 3),
(22, 'Mesmo quando estudar é difícil, encontro uma maneira de continuar estudando.', 6, 4),
(23, 'É fácil eu permanecer estudando, mesmo que eu prefira estar fazendo alguma outra coisa.', 6, 5),
(24, 'Se o que estudo não me parece importante, mesmo assim, consigo continuar estudando.', 6, 6),
(25, 'Se eu prbermsar, tenho maneiras de me convencer a continuar fazendo uma tarefa difícil.', 6, 7),
(26, 'Se estudar fica muito chato, encontro uma maneira de tornar o estudo divertido.', 6, 8),
(27, 'Mesmo que uma leitura pareça muito sem sentido, obrigo-me a continuar lendo até terminá-la.', 6, 9),
(28, 'Se uma leitura é difícil, mesmo assim, encontro uma forma de me manter engajado(a) e de terminá-la.', 6, 10),
(29, 'Eu me obrigo a me manter lendo, mesmo quando a leitura é realmente chata.', 6, 11),
(30, 'Consigo me obrigar a continuar lendo, mesmo que eu sinta vontade de desistir da leitura.', 6, 12),
(31, 'Alguns alunos deixam para estudar nas vésperas da prova. Caso se saiam mal, dizem que não tiveram tempo suficiente para estudar toda a matéria.', 7, 1),
(32, 'Alguns alunos não estudam com afinco e quando se saem mal, dizem que não é possível obter bons resultados, pois a carga horária do seu curso é muito pesada.', 7, 2),
(33, 'Alguns alunos ficam mexendo no celular, durante as aulas. Caso não tenham um bom resultado dizem que foi porque não entenderam a explicação do professor.', 7, 3),
(34, 'Alguns estudantes saem frequentemente de sala de aula. Caso tirem uma nota baixa na prova, dizem que foi porque perderam conteúdos importantes.', 7, 4),
(35, 'Alguns alunos saem para passear mesmo quando têm de fazer um trabalho importante. Caso se saiam mal, dizem que tiveram pouco tempo para realizá-lo.', 7, 5),
(36, 'Alguns alunos envolvem-se propositalmente em muitas atividades. Se não se saírem bem na universidade, dizem que estiveram muito ocupados com outras coisas.', 7, 6),
(37, 'Alguns estudantes participam de várias festas mesmo quando têm de entregar um trabalho importante. Caso o resultado não seja bom, dizem que a proposta do trabalho era muito complexa.', 7, 7),
(38, 'Alguns alunos conversam com os colegas durante a aula. Caso não se saiam bem na disciplina, dizem que os amigos os distraíram.', 7, 8),
(39, 'Alguns alunos sempre deixam para depois o estudo e a realização de trabalhos acadêmicos, às vezes, chegando ao ponto de não realizá-los. Caso se saiam mal na disciplina, dizem que foi por falta de tempo.', 7, 9),
(40, 'Alguns alunos não leem os textos recomendados pelos professores, antes das aulas. Caso se saiam mal na avaliação, dizem que foi porque os textos eram muito chatos.', 7, 10),
(41, 'Alguns alunos realizam outras atividades (assistem televisão, ouvem música ou navegam na internet) mesmo sabendo que tem pouco tempo para fazer um trabalho. Caso não se saiam bem, dizem que o trabalho era muito extenso.', 7, 11),
(42, 'Alguns estudantes relatam que tem de ficar com os amigos e/ou com a namorado(a). Caso não façam um bom trabalho, dizem que não tiveram tempo para investir nos estudos.', 7, 12),
(43, 'Alguns alunos não se preparam e então se sentem muito ansiosos no momento da realização de uma prova. Caso se saiam mal, dizem que a ansiedade os prejudicou.', 7, 13),
(44, 'Alguns alunos estudam o conteúdo errado da prova. Caso não tenham um bom desempenho, dizem que foi essa a razão.', 7, 14),
(45, 'Alguns alunos adiam a realização de algumas tarefas importantes até o limite do prazo estabelecido pelo professor. Caso se saiam mal, dizem que o trabalho foi feito de última hora.', 7, 15),
...
--
ALTER TABLE `alternativas`
  ADD CONSTRAINT `fk_alternativas_questionarios1` FOREIGN KEY (`questionarios_id`) REFERENCES `questionarios` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Restrições para tabelas `convidados`
--
ALTER TABLE `convidados`
  ADD CONSTRAINT `fk_convidados_1` FOREIGN KEY (`idlista`) REFERENCES `listas` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Restrições para tabelas `participantes`
--
ALTER TABLE `participantes`
  ADD CONSTRAINT `fk_participantes_cursos` FOREIGN KEY (`curso_id`) REFERENCES `cursos` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_participantes_universidades1` FOREIGN KEY (`universidades_id`) REFERENCES `universidades` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Restrições para tabelas `questoes`
--
ALTER TABLE `questoes`
  ADD CONSTRAINT `fk_questoes_questionarios1` FOREIGN KEY (`questionarios_id`) REFERENCES `questionarios` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Restrições para tabelas `respostas`
--
ALTER TABLE `respostas`
  ADD CONSTRAINT `fk_respostas_alternativas1` FOREIGN KEY (`alternativa_id`) REFERENCES `alternativas` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_respostas_participantes` FOREIGN KEY (`participante`) REFERENCES `participantes` (`uid`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_respostas_questoes1` FOREIGN KEY (`questao_id`) REFERENCES `questoes` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Restrições para tabelas `universidades`
--
ALTER TABLE `universidades`
  ADD CONSTRAINT `fk_estado_1` FOREIGN KEY (`estado`) REFERENCES `estados` (`uf`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_universidades_cidades1` FOREIGN KEY (`cidade`) REFERENCES `cidades` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
